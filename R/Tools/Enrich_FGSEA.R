...
RunEnrichment_GO_new<-function(scores = c(), df = NULL, genes = "Genes", Score = "ES",organism="mmu",orgDB=NULL)
{
print("Download GO")
...
out<-RunEnrichment(scores=scores,df=df,genes=genes,Score=Score,CleanTerms=tab)
print("Get ONTs")
